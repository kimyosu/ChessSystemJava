...
public class UI {
    ...
    public static ChessPosition readChessPosition(Scanner scanner){
        try {
            ...
            char column = s.charAt(0); //pega o primeiro caractere da string
            int row = Integer.parseInt(s.substring(1)); //pega o segundo caractere da string e converte para inteiro
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        ...
        white.forEach(x -> System.out.print(x + " "));

        System.out.println(ANSI_RESET);

        System.out.print("Black: ");
        System.out.print(ANSI_YELLOW);
        black.forEach(x -> System.out.print(x + " "));
        System.out.println();
